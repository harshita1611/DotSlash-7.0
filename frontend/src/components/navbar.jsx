    ...
    <header className="bg-white px-16 py-8 max-md:px-5">
      <nav className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
        ...
        <div className="flex flex-col items-stretch w-[26%] ml-5 max-md:w-full max-md:ml-0">
          <button
            className="text-white text-2xl font-bold whitespace-nowrap bg-black grow justify-center items-stretch w-max px-7 py-5 rounded-[30px] max-md:mt-10 max-md:px-5 ml-auto"
